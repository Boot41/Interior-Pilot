"""
Django settings for interior_pilot project.
...
ALLOWED_HOSTS = ['*']  # For development only - make this more restrictive in production
...
ROOT_URLCONF = 'interior_pilot.urls'
...
WSGI_APPLICATION = 'interior_pilot.wsgi.application'
