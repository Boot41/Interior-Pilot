...
const RoomDesign = () => {
    ...
    const options = {
        theme: ['Modern', 'Minimalist', 'Vintage', 'Scandinavian'],
        room_type: ['Bedroom', 'Living Room', 'Kitchen', 'Bathroom', 'Office', 'Playroom', 'Study Room', 'Gaming Room'],
        color: ['Blue', 'Red', 'Green', 'Yellow', 'Purple', 'Pink', 'White', 'Black', 'Gold', 'Silver', 'Brown', 'Orange'],
    };

    const themeDescriptions = {
      Modern: "Clean lines, minimal ornamentation, and a focus on function. Neutral color palettes with bold accents.",
      Minimalist: "Less is more philosophy, Monochromatic color schemes, Essential furniture only, no clutter",
      Vintage: "Classic and retro elements, Warm, muted color palettes, Mix of antique and modern pieces",
      Scandinavian: "Light, airy spaces with natural light, Neutral tones with pastel accents, Functional design with natural materials"
    };
        ...
        <div className="min-h-screen bg-gradient-to-b from-[#FDF8EF] via-[#F8F1E3] to-[#F5EAD7] py-24 px-8 relative overflow-hidden">
            ...
            >
                <h1 className="text-6xl font-extrabold text-[#8B4513] leading-tight">
                    Use Your Inspiration to Design Your Room
                </h1>
                    ...
                    <div className="bg-white/80 backdrop-blur-md rounded-2xl shadow-[0_8px_30px_rgb(218,165,32,0.1)] p-8 border border-[#DAA520]/20">
                        <form onSubmit={handleSubmit} className="space-y-8">
                            ...
                            <div className="space-y-4">
                              ...
                              <div className="grid grid-cols-2 gap-4">
                                {Object.entries(themeDescriptions).map(([theme, description]) => (
                                  ...
                                  >
                                    <h3 className="text-lg font-semibold text-[#8B4513]">{theme}</h3>
                                    <p className="text-sm text-[#6B4423] mt-2">{description}</p>
                                  </div>
                                ))}
                              </div>
                            </div>
                          ...
                          <div className="space-y-2">
                            ...
                            <textarea
                              value={formData.additional_notes} // Changed from additionalNotes
